import { Component, OnInit, Output, EventEmitter, Input, ViewChild, ElementRef, ChangeDetectionStrategy, OnChanges, SimpleChanges } from '@angular/core';
...
export class SearchInputComponent implements OnInit, OnChanges {
  ...
  @Input() public withResult:boolean =true;
  @Input() public isMobileScreen:boolean
  @Input() public shouldSearchUpdate:boolean
  ...
  ngOnChanges(changes: SimpleChanges): void {
      if(changes && changes.shouldSearchUpdate && changes.shouldSearchUpdate.currentValue){
        this.resetInput()
        this.onSearchChange('')
      }
  }
