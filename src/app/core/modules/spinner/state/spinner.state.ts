...
@State<SpinnerStateModel>({
  ...
  defaults: {
    ...
    excludedUrls: [
      ...
      'Request/GetMyLeaveBalance',
      'api/Profile/SearchBusinessPartnerTeam',
      'Request/GetMyJoinedEntitiesWebAPI',
      '/api/Request/GetAllCycles',
      '/api/Profile/SearchEmployees',
      '/api/Request/GetAllTeams',
      '/api/Request/DownloadUploadedFile',
      '/api/Request/FindSkill'
    ],
  },
})
